                    ...
                    <form role="search" method="get" class="search-form" action="<?php echo home_url('/'); ?>">
                        <div class="row no-gutters mx-0">
                            <div class="col-lg-7 col-9 px-0">
                                ...
                                <input type="search" class="form-control search_input" placeholder="<?php echo esc_attr_x('Pesquisar...', 'placeholder') ?>" value="<?php echo get_search_query() ?>" name="s" title="<?php echo esc_attr_x('Search for:', 'label') ?>" />
                            </div>
